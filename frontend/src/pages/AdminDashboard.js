...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    axios.get(`${API}/api/admin/stats`, { withCredentials: true }).then(r => setStats(r.data)).catch(() => {});
    axios.get(`${API}/api/orders`, { withCredentials: true }).then(r => setRecentOrders(r.data.slice(0, 5))).catch(() => {});
  }, []);
